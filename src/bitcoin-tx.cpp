...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thebestcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thebestcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thebestcoin transaction") + "\n" +
              "  thebestcoin-tx [options] -create [commands]   " + _("Create hex-encoded thebestcoin transaction") + "\n" +
              "\n";
